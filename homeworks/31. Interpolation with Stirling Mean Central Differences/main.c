/**
    ANSI C standard: c11
    main.c
    Purpose: Gauss interpolation with central Backward differences
...
#include "numsys/interpolation/stirling.h"
...
int main(int argc, char *argv[]) {
    ...
    double * y_samples = stirling_central_diff_evaluation(x.items, y.items, x.size, h, x_samples.items, x_samples.size);
