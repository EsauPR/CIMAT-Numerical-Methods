/**
    ANSI C standard: c11
    main.c
    Purpose: Gregory-Newton interpolation with forward differences
...
int main(int argc, char *argv[]) {
    ...
    double * y_samples = gregory_newton_fw_evaluation(x.items, y.items, x.size, h, x_samples.items, x_samples.size);
