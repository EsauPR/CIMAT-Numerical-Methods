...
Como se vió anteriomente la solución de la función *stress* está dada por 
...
knitr::kable(data.frame(method, iterations, time, stress_diff), caption = 'Resultados de los métodos internos de solución', col.names=col_names)
```
